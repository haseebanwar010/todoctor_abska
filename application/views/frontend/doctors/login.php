...
<div class="clear"></div>
                    ...
                    <div class="registration-wrapper">
                    	<h2>Doctor Login</h2>
                        	...
                        	<div class="logins_app ">
                    	   	<div class="login_icons login_icons1"></div>
    ...
    <?php } ?>
                        ...
                        <div class="input-files">
                         ...
                         <a href="<?php echo $baseUrl; ?>doctor/forgotpassword" class="forgot">Forgot Password </a>
                    <a href="<?php echo $baseUrl; ?>doctor/registration" class="new-account">New Account</a>
                        </div></div>
