...
<!--                  <td><?php echo $appointment['about_disease']; ?></td>-->
                  ...
                  <td class="doctoractions">
                      <?php if($appointment['status']!=1){ ?>
                      <a href="<?php echo $baseUrl; ?>doctor/approveappointment/<?php echo $appointment['id']; ?>"><button class="btn btn-info">Approve</button></a>
                      <a href="<?php echo $baseUrl; ?>doctor/rejectappointment/<?php echo $appointment['id']; ?>"><button class="btn btn-info">Reject</button></a>
                      <?php } ?>
                    </td>
                </tr>
                    <?php } ?>
